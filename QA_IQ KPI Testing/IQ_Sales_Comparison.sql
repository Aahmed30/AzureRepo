...
and  kpi.fiscal_month in (10,11,12)
...
and c1.fiscal_month in (10,11,12)
group by 
c1.fiscal_year
, c1.fiscal_month
, c2.fiscal_month
...
Events_Services cy
  ...
  where cy.Center_ID='0889' and cy.fiscal_year=2021 
  and cy.fiscal_month in (10,11,12)
...
from
 ...
 -- on cast(cy.fiscal_Year as int) -2 = cast(py.fiscal_Year as int)
  ...
  and cy.center_id = py.center_id
   ...
   where  cy.Center_ID ='0334' and cy.fiscal_year=2021
   and cy.fiscal_month in (10,11,12)
...
Events_Services cy
  ...
  and cy.sku_type = py.sku_type
  and cy.Center_ID = py.Center_ID
  where cy.Center_ID='0539' and cy.fiscal_year=2021 
  and cy.fiscal_month in (10,11,12)
  Group by cy.fiscal_year
  , cy.fiscal_month
  , cy.Center_ID
...
from
 ...
 -- on cast(cy.fiscal_Year as int) -1 = cast(py.fiscal_Year as int)
  ...
  and cy.center_id = py.center_id
   ...
   where  cy.Center_ID ='0542' and cy.fiscal_year=2021
   and cy.fiscal_month in (10,11,12)
   GROUP BY cy.fiscal_year ,cy.fiscal_month, py.fiscal_year
    ,cy.Center_ID
    ,cy.Sales_Revenue
