...
SELECT
  ...
  where
    ep.source_id = 2
  AND ep.payment_in_center_timestamp >= cast('2021-03-01 00:00:00' as timestamp)
  AND ep.payment_in_center_timestamp <= Cast('2021-03-31 23:59:00' as timestamp)
